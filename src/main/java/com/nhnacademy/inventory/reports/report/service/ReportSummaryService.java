...
public class ReportSummaryService {
    ...
    private static final String PROMPT = """
        ...
        3. 환경 데이터에서 기준을 벗어난 구역이 있으면 보관 품질 관점에서 짚고, 폐기 내역과 연관지어 해석할 수 있으면 함께 언급하세요.
        4. 기준이 미설정인 항목은 이탈 여부를 판단하지 말고, 필요하면 기준 설정을 권고하세요.
        5. 해당 데이터가 '없음'인 항목은 그 절을 생략하세요.
        6. 아래 예시와 완전히 동일한 형식으로 작성하세요.
        ...
        보관 환경 분석
        구역 1의 온도가 기준 상한을 넘은 날이 있었고, 같은 구역의 문 개폐가 잦았습니다. 개폐 빈도가 온도 상승에 영향을 주었을 가능성이 있습니다.

        관리자 권고사항
        A의약품(10정)의 안전재고를 우선 점검하고, 폐기 사유를 확인해 발주량 조정을 검토하십시오. 구역 1의 문 개폐 관리와 온도 기준 준수 여부를 함께 점검하십시오.
